...
#include "quantsystem/common/base/scoped_ptr_internals.h"
...
//
// scoped_ptr<int, common::base::FreeDeleter> foo_ptr(
...
class scoped_ptr<C[], D> {
 public:
  ...
  explicit scoped_ptr(T* array) : impl_(array) {
    static_assert((common::base::is_same<typename common::base::remove_cv<C>::type,
                                 typename common::base::remove_cv<T>::type>::value),
...
//
template<class C, class D = common::base::FreeDeleter>
