...
class Status {
 public:
   ...
   */
  Status() : code_(quantsystem::common::util::error::OK) {}
   ...
   */
  Status(quantsystem::common::util::error::Code code, const StringPiece& msg)
   ...
   */
  bool ok() const { return code_ == quantsystem::common::util::error::OK; }
   ...
   */
  quantsystem::common::util::error::Code error_code() const { return code_; }
 ...
 private:
  quantsystem::common::util::error::Code code_;
  string msg_;
};
