...
#ifndef QUANTSYSTEM_COMMON_DATA_MARKET_TICKS_H_
#define QUANTSYSTEM_COMMON_DATA_MARKET_TICKS_H_
...
namespace market {
/**
 * Ticks collection which implements a Dictionary string list of ticks. This
 * way users can iterate over the string indexed ticks of the requested symbol.
 * @ingroup CommonBaseData
 */
class Ticks: public BaseData {
 public:
  /**
   ...
   */
  explicit Ticks(const DateTime& frontier);
  ...
  void Add(const string& key, const vector<Tick*>& value);

  void Add(const string& key, Tick* value);
 ...
 private:
  typedef map<const string, vector<Tick*> > TickMap;
  TickMap ticks_;
};
...
#endif  // QUANTSYSTEM_COMMON_DATA_MARKET_TICKS_H_
