...
#ifndef QUANTSYSTEM_ENGINE_SETUP_PAPER_TRADING_SETUP_HANDLER_H_
#define QUANTSYSTEM_ENGINE_SETUP_PAPER_TRADING_SETUP_HANDLER_H_
...
namespace setup {
/**
 * Papertrading setup handler processes the algorithm initialize method
 * and sets up the internal state of the algorithm class.
 * @ingroup EngineLayerSetup
 */
class PaperTradingSetupHandler : public ISetupHandler {
 public:
  /**
   * Setup the algorithm data, cash, job start end date etc.
   */
  PaperTradingSetupHandler();
...
#endif  // QUANTSYSTEM_ENGINE_SETUP_PAPER_TRADING_SETUP_HANDLER_H_
