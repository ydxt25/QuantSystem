...
#ifndef QUANTSYSTEM_ENGINE_SETUP_CONSOLE_SETUP_HANDLER_H_
#define QUANTSYSTEM_ENGINE_SETUP_CONSOLE_SETUP_HANDLER_H_
...
namespace setup {
/**
 * Console setup handler to initialize and setup the  Engine properties
 * for a local backtest.
 * @ingroup EngineLayerSetup
 */
class ConsoleSetupHandler : public ISetupHandler {
 public:
  /**
...
#endif  // QUANTSYSTEM_ENGINE_SETUP_CONSOLE_SETUP_HANDLER_H_
